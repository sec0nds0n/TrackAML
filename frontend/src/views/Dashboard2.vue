                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center gap-4 text-xs">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="text-gray-600 dark:text-gray-300">WEW: {{ cryptoMetrics.suspiciousTransactions.btc }}</span>
                                    </div>
                                    <div class="flex items-center gap-1">
                    ...
                    <div class="relative overflow-hidden bg-gradient-to-br from-green-50 via-green-50 to-green-100 dark:from-green-900/20 dark:via-green-900/15 dark:to-green-800/20 rounded-xl p-6 border border-green-200 dark:border-green-800/30">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <p class="text-3xl font-bold text-green-900 dark:text-green-100 mb-2">{{ cryptoMetrics.complianceScore.score }}%</p>
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 xl:col-span-8">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    ...
                    <div class="h-80 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-600 flex items-center justify-center relative overflow-hidden">
                        <div class="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10"></div>
                        <div class="text-center z-10">
                            <div class="mb-4">
                                <svg class="w-16 h-16 text-indigo-400 dark:text-indigo-500 mx-auto animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                </svg>
                            </div>
                            <h4 class="text-lg font-bold text-gray-700 dark:text-gray-300 mb-2">Advanced Flow Analytics</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Real-time cryptocurrency transaction flow visualization</p>
